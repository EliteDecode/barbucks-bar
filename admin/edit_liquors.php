...
<body>
            ...
            <div class="col-md-10 col-lg-10 col-xl-10 ">
                <div class="container mt-3 ">
                    ...
                    <?php if (isset($_GET['id'])) {
                        $id = $_GET['id'];
                        $result = selectOne('liquors', ['id' => $id]);
                        $product = $result['Product'];
                        $price_per_can = $result['Price_per_can'];
                        $price_of_drink = $result['Price_of_drink'];
                        $empty = $result['Weight_of_bottle'];
                        }?>
                    <form id='post_form' enctype="multipart/form-data" onsubmit="return false"
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4 col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="e.g. Buldweiser" id='product'
                                        name='product' value='<?php echo $product ?>'>
                            ...
                            <div class="col-lg-4 col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="e.g. $6" id='price_per_can'
                                        name='price_per_can' value='<?php echo $price_per_can ?>'>
                            ...
                            <div class="col-lg-4 col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="e.g. $6" id='price_of_drink'
                                        name='price_of_drink' value='<?php echo $price_of_drink ?>'>
                            ...
                            <div class="col-lg-4 col-md-3 col-sm-12">
                                <div class="form-group">
                                    <label for="weight_empty_liquor">Weight of empty liquor</label>
                                    <input type="text" class="form-control" placeholder="e.g. 6.5oz"
                                        id='weight_empty_liquor' name='weight_empty_liquor'
                                        value='<?php echo $empty ?>'>
                                    <div class="invalid-feedback error-weight_empty_liquor">
                                        Please enter weight of empty bottle of liquor
                                    </div>
                                </div>
                            </div>
    ...
    function add_post() {
        ...
        var weight_empty_liquor = $('#weight_empty_liquor').val()
        ...
        if (weight_empty_liquor == "") {
            $("#weight_empty_liquor").removeClass('form-control').addClass('form-control is-invalid');
            $('.error-weight_empty_liquor').show();

        } else {
            $("#weight_empty_liquor").removeClass('form-control is-invalid').addClass('form-control');
            $('.error-weight_empty_liquor').hide();
        }



        if (product != "" && price_of_drink != "" && price_per_can != "" && weight_empty_liquor != "") {

            $('#add_btn').html('Please Wait....')
            var formData = new FormData(document.getElementById('post_form'))
            fetch('ajax_controls/edit_liquors.php', {
                    method: 'POST',
                    body: formData
                })
