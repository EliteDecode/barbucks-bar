...
<body>
                ...
                <div class="container mt-3 ">
                    ...
                    <form id='post_form' enctype="multipart/form-data" onsubmit="return false"
                        ...
                        <div class="flex items-center space-x-2 my-4">
                            <h6 class="font-bold uppercase text-md text-blue-600">Add Liquor</h6>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4 col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="e.g. Vodka" id='product'
                                        name='product'>
                                    <div class="invalid-feedback error-product">
                                        Please enter liquor name
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="invalid-feedback error-price_per_can">
                                        Please enter price per can of liquor
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" placeholder="e.g. 6.5oz"
                                        id='weight_empty_liquor' name='weight_empty_liquor' value='0'>
    ...
    function add_post() {
        ...
        if (product != "" && price_of_drink != "" && price_per_can != "" && weight_empty_liquor != "") {
            ...
            fetch('ajax_controls/add_liquors.php', {
                    method: 'POST',
                    body: formData
                })
